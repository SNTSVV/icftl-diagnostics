...
class Generator(GeneratorBase):
    ...
    def generate_code_line_list(self) -> list[InstrumentationLine]:
        ...
        code = f"""{self._indentation}{self._instrument_function}({{"type": "measurement", {spec_id}, "atom_index": {self._atom_index}, "subatom_index": {self._subatom_index}, "value": {self._subatom.get_program_variable()}, {time}, {line_number}, {module_name}}})"""
